...
export async function POST(request: Request) {
    try {
        ...
        const response = await fetch(`${agentCoreUrl}/api/v1/orchestration/stock-audit`, {
            method: 'POST',
            headers: {
            ...
            body: JSON.stringify({
                ...
                force_recount: Boolean(body.force_recount),
                reason: body.reason || 'Solicitud de auditoría de stock desde App BFF',
            }),
        });
        ...
        console.error('Error en BFF stock-audit:', e);
